...
| Module (PDF)                                                                   | Type  | Pts | Statut                                                      | Owner                 | Notes                                                                                                       |
| ------------------------------------------------------------------------------ | ----- | --- | ----------------------------------------------------------- | --------------------- | ----------------------------------------------------------------------------------------------------------- |
| **ELK** (ES + Logstash + Kibana, rétention, sécurisation)                      | Major | 2   | Fait | Mileum (Théo)| Finaliser rétention / accès                                                                                 |
...
| Module (PDF)                                                               | Type  | Pts | Statut   | Owner            | Notes                                                                                                                                                                                                                                                                                                                             |
| -------------------------------------------------------------------------- | ----- | --- | -------- | ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Dashboard analytique avancé (charts, temps réel, export, filtres)          | Major | 2   | fait | Mileum (Théo)    | **Front** : écran stats perso avec graphiques (complémentaire au dashboard global IV.8)                                                                                                                                                                                                                                           |
|                                                                            |       |     |          |                  |                                                                                                                                                                                                                                                                                                                                   |
