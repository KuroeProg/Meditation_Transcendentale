...
| --------------------------------------------------------------------------------------------------------------- | ----- | --- | --------------- | --------- | -------------------------------------------------------------------------------------------- |
| **Audio** — expérience sonore globale (BGM, SFX, préférences partagées jeu + home, polish fin de partie / menu) | Minor | 1   | Quasi, bonus | Vyke, Fey | BGM home (`Beth's Story.m4a`) hors `/game/*` ; BGM partie (`Theme_of_game.wav`) au 1er coup ; chrono blanc figé avant 1er coup (UI) ; README `public/sounds/` + racine à jour. |
